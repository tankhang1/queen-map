...
const R7Report = ({ filterDate }: { filterDate: TFilter }) => {
  const { data: r7Report } = useGetReportQuery(
    {
      code: "MT",
  ...
  // Group logs by date
  const statsByDate = (r7Report || []).reduce((acc, log) => {
  ...
  return (
    <Stack>
      <Text fw={"bold"}>Sầu riêng Monthong</Text>
